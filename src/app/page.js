...
const providers = [
  ...
  { name: "Steam CS DBG", providerId: "1bba104c-f7e3-4b58-8b42-f8c0346cdezz" },
  { name: "Github UserName - Fix", providerId: "eea88931-af56-471f-bbc0-5df8330e52f8" },
  { name: "Atleast one Uber Ride", providerId: "55535317-71ad-4cac-9a38-22652e64be9e" },
  { name: "DSID Solana ID Twitter Verifier v2", providerId: "39c31ffd-0be0-4e45-9a18-1eb3cb8099d4" },
  { name: "Kaaggle username PP", providerId: "c94476a0-8a75-4563-b70a-bf6124d7c59z" },
  { name: "Aadhaar Card Date of Birth v2", providerId: "5e1302ca-a3dd-4ef8-bc25-24fcc97dc801" },
  { name: "CreditKarma Scores", providerId: "add9a3cc-a13e-4572-818d-62446bcae8ef" },
  { name: "DND HGF dbg", providerId: "aaa47198-2523-40da-b9a9-bfa290730d55" }
];
  ...
  return (
    <main className="flex min-h-screen flex-col items-center justify-between p-8 mt-8 gap-4 bg-black">
      <div className="z-10 w-full flex flex-col gap-4 items-center justify-center font-mono text-sm">
        <h2 className="text-slate-300 text-sm lg:text-4xl md:text-3xl sm:text-xl xs:text-xs text-nowrap">Welcome to Reclaim Protocol Demo (Providers test)</h2>
